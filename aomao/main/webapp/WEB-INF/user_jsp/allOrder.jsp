...
<div class="logoAndSearch w1190 textWarp">
    ...
    <!--购物车-->
    <a  onclick="goToCars()" href="javascript:void(0);" target="_self" class="buy_car">
        <p>购物车</p>
        <em>0</em>
    </a>
    <!-- 新会员 -->
...
<!-- 导航 -->
<div class="wrap-all">
    <div class="center_1200 nav_list_wrap" style="height: 450px">
        <!--左边二级菜单-->
        <div class="main_menu"  style="height: 45px">
            ...
            <div class="MeLeftNav">
                ...
                <div class="MeTitle">
                    ...
                    <dl class="MeInformation">
                        <dt><em>个人信息</em></dt>
                        <dd onclick="updataPwd()"><em><i>·</i>修改密码</em></dd>
...
<div class="foot">
    <!-- 保证 -->
    <div class="BZ center_1200 textWarp" style="height: 1000px">
