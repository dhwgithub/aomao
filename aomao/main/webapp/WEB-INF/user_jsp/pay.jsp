...
<div class="Blurbw boxS w1190">
    <div class="Blur">
        ...
        <table align="center" style="width: 80%;">
            <tr>
                <td style="font-size: 60px; float: left;">支付宝</td>
                <td style="font-size: 60px; ">　微信支付</td>
            </tr>
            <tr>
                <td ><img style="width: 30%;" src="images/zhifubao1.jpg"/></td>
                <td ><img style="width: 50%;margin-left: 20%;" src="images/weixinzhifu.jpg"/></td>
            </tr>
        </table>
