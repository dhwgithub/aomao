...
<div class="MeMainW">
    <div class="MeMain  w1190">
        <div class="MeArea clearfix">
            ...
            <div id="myInfo" class="MecenterArea" style="float: left; width: 500px;" >
<%--                <h3 class="clearfix" style="width: 975px;">--%>
<%--                    <span style="font-size: 20px;">个人信息</span>--%>
<%--                </h3><br/><br/><br/>--%>
<%--                <p class="userName" style="width: 975px; ">--%>
<%--                    <em></em>--%>
<%--                    <div class="W310" style="font-size: 20px;">身份证：******************</div>--%>
<%--                <P/><br/>--%>
<%--                <p class="userName" style="width: 975px; ">--%>
<%--                    <em></em>--%>
<%--                    <div class="W310" style="font-size: 20px;">账号：</div>--%>
<%--                <P/><br/>--%>
<%--                <p class="userName" style="width: 975px; ">--%>
<%--                    <em></em>--%>
<%--                <div class="W310" style="font-size: 20px;">邮箱：</div>--%>
<%--                <P/><br/>--%>
<%--                <p class="userName" style="width: 975px; ">--%>
<%--                    <em></em>--%>
<%--                <div class="W310" style="font-size: 20px;">性别：</div>--%>
<%--                <P/><br/>--%>
<%--                <p class="userName" style="width: 975px; ">--%>
<%--                    <em></em>--%>
<%--                <div class="W310" style="font-size: 20px;">信用分：</div>--%>
<%--                <P/><br/>--%>
    ...
    function getMyInfoAll(){
        $.ajax({
            ...
            success:function (data) {
                if(data.code == 100){
                    $("#myInfo").html('<h3 class="clearfix" style="width: 975px;">\n' +
                        '                    <span style="font-size: 20px;">个人信息</span>\n' +
                        '                </h3><br/><br/><br/>\n' +
                        '                <p class="userName" style="width: 975px; ">\n' +
                        '                    <em></em>\n' +
                        ...
                        '                <p class="userName" style="width: 975px; ">\n' +
                        '                    <em></em>\n' +
                        '                    <div class="W310" style="font-size: 20px;">账号：'+data.uname+'</div>\n' +
                        '                <P/><br/>\n' +
                        '                <p class="userName" style="width: 975px; ">\n' +
                        '                    <em></em>\n' +
                        '                <div class="W310" style="font-size: 20px;">邮箱：'+data.uemail+'</div>\n' +
                        '                <P/><br/>\n' +
                        '                <p class="userName" style="width: 975px; ">\n' +
                        '                    <em></em>\n' +
                        '                <div class="W310" style="font-size: 20px;">性别：'+data.ugender+'</div>\n' +
                        '                <P/><br/>\n' +
                        '                <p class="userName" style="width: 975px; ">\n' +
                        '                    <em></em>\n' +
                        '                <div class="W310" style="font-size: 20px;">信用分：'+data.ugender+'</div>\n' +
                        '                <P/><br/>');
                }else{
