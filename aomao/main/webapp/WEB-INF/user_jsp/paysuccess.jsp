...
<div class="Blurbw boxS w1190">
    <div class="Blur">
        <h3 class="Contitle" style="float: left;">
            支付成功
        </h3>
        <h3 class="Contitle" style="float: left;">
            <a href="Member-allOrder.html">查看订单</a>
        </h3>
        <h3 class="Contitle" style="float: left;">
            <a href="list.html">返回主页</a>
        </h3>
        <!--<div class="BlurArea">-->

        <!--<div class="prouduct clearfix">-->
        <h1 style="font-size: 60px; color: green; padding-top: 40px;">Successful payment！</h1>


        <!--<button style="font-size: 20px;color: blue;float: right; height: 50px;width: 100px; margin-top: -30px;">已扫码</button>-->
        <!--	</div>-->
